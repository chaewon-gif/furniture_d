              ...
              {page.productList.map((product, index) => {
                ...
                return (
                  <div
                    ...
                    key={index}
                  >
                    <div className="border hover:border-accent rounded-[18px] w-full max-w-[280px] h-full max-h-[292px] flex items-center justify-center mb-[15px] relative transition">
                      <img
                        src={image.type}
                        alt=""
                      />
